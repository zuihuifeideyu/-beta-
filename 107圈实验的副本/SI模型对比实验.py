...
print(DC_nodes)
#前五个1888,1800,1663,1352,1730,1431,1199,1584,1768,1086  8个
...
print(BC_nodes)
#前五个1086,1584,917,483,1334,1371,606,1703,637,1536  1个
'''
#1888,1663,1800,1352,1199,1589,1431,1730,1833,1584



ls1 = [1888,1663,1800,1352,1199]
ls2 = [1888,1800,1663,1352,1730]
ls3 = [1086,1584,917,483,1334]
ls4 = [483,917,1536,1783,1730]
ls5 = [1086,1584,1800,1334,483]
...
def draw_picture(nums, max_iter_num, infect1, recover1, infect2, recover2, infect3, recover3, infect4, recover4,
    ...
    plt.plot(x, infect4, color='y', lw=1, marker='h', linestyle='-.', label='PR')
    plt.plot(x, infect5, color='m', lw=1, marker='d', linestyle='-.', label='CC')
    plt.plot(x, infect1, color='r', label='GTM', lw=1, marker='s', linestyle='-')
    '''
    ...
    plt.yticks(range(0, nums, 200))  # 修改y的刻度
